...
Unfortunately this react app will not work properly (or at all!!) without the Metamask extension for chrome: https://metamask.io/
...
npm start
```
If this throws horrible errors maybe also try
```
